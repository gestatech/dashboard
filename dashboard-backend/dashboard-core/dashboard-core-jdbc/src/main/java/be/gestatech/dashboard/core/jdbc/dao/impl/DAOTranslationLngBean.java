 ...
 */
@Stateless
public class DAOTranslationLngBean extends DataSourceProvider implements DAOTranslationLocal {

	private final Logger LOGGER = Logger.getLogger(DAOTranslationLngBean.class.getName());
