package be.gestatech.ecosytem.entity.policy;
...
import be.gestatech.ecosytem.entity.user.UserGroups;
...
public class Policy implements Serializable,Identifiable<Integer> {
